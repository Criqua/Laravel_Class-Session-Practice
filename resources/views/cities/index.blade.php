            ...
            <div class="flex gap-3">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute hidden group-hover:block bg-white dark:bg-gray-800 shadow-lg rounded-lg z-10 w-40">
                        <a href="{{ route('cities.export.csv') }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">{{ __('Exportar CSV') }}</a>
                        <a href="{{ route('cities.export.xlsx') }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">{{ __('Exportar Excel') }}</a>
                    </div>
                </div>
            </div>
        </div>
